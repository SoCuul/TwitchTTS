...
class SayPlatformBase {
   ...
   * @param {number|null} volume The volume of the spoken text
   ...
   */
  speak (text, voice, volume, speed, callback) {
    ...
    let { command, args, pipedData, options } = this.buildSpeakCommand({ text, voice, volume, speed })
